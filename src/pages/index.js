...
const IndexPage = () => (
  <div>
    ...
    <p>ed25519, as an <a href="https://en.wikipedia.org/wiki/Elliptic-curve_cryptography">elliptic curve cryptography</a>(ECC) signature algorithm, offers high security signatures in a small signature size. A 256 bit ECC key has similar security properties to 3072 bit RSA signatures (see table 3, page 53 of <a href="https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-57pt1r4.pdf">NIST SP 800-57</a>).</p>
    ...
    <ul>
      ...
      <li><a href="https://www.knot-dns.cz/">Knot DNS</a> (unreleased) will support ed25519 in <a href="https://gitlab.labs.nic.cz/knot/knot-dns/merge_requests/763">2.6</a> using <a href="https://nikmav.blogspot.com/2017/08/gnutls-3-6-0.html">GnuTLS 3.6.0</a></li>
      <li><a href="https://unbound.net">Unbound</a> (since <a href="https://unbound.net/download.html">1.6.4</a>) supports ed25519 via the unreleased OpenSSL 1.1.1 and since version 1.6.6 via <a href="http://www.lysator.liu.se/~nisse/nettle/">libnettle</a></li>
